...
public class Commenting {
	...
	public static void main(String[] args) {
		...
		String stringNum = ""; //stringNum's value is a blank
		...
		num2 = ((int)num2) - num1; //num2's value is -16.0
		stringNum = num1 + " " + num2; //stringNum's value is "52 -16.0"
		...
		stringNum = stringNum + "; "; //stringNum's value is "52 -16.0;"
		stringNum = stringNum + num1 + " " + num2; //stringNum's value is "26 -6.4"
		/*
		 * Variables Name    |   Value
		 * ---------------------------------
		 * num1              | 26
